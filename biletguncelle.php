    ...
    <section>
        <div class="conteiner">
            <div class="user siginBox">
                ...
                <div class="formBox">
                    <form method="get" action="biletguncelle2.php"> <!-- buradaki forma girilen veriler post methodu ile gönderilir -->
                        <h2>Bilet Güncelle</h2> <!-- başlık  -->

                        ID:<input type="text" name="rn" placeholder="TC No"name ="rn" value="<?php echo "$rn" ?>" readonly>  <!-- kullanıcı adının girileceği textbox -->
                        TC No:<input type="text" name="fn" placeholder="TC No" value="<?php echo "$fn" ?>" readonly>  <!-- kullanıcı adının girileceği textbox -->
                        Nereden:
                        <input type="text"name ="ln"   id="ln" value="<?php echo "$ln" ?>" readonly>   <!-- veritabaınından nereden kolonu buradaki listbox a çekilir-->
                        <br>
                      
                        
                        Nereye:
                        <input type="text"name ="em"   id="em" value="<?php echo "$em" ?>" readonly> <!-- kullanıcıdan nereye gidileceği hakkında bilgi alınır -->
                        <div class="form-group"></div>
            
           
                        Koltuk No.:
                        <br>
                        <select name="me" value= <?php echo"$me"?>>  <!-- koltuk numarasını seçmesi için listbox ve içine yazılan veriler for dongüsü ile 40 kere yazıdırılmıştır-->
                        <option value="asd" selected><?php echo"$me"?></option>
                        <option>   
                             <?php
                                for($i =1;$i<=40;$i++)
                                {
