...
<body> 
    <div class="conteiner">
        <div class="navbar">
            ...
            <ul>
                <li><a href="index.php"class="active">Anasayfa</a></li> <!-- navbar tuşarı-->
                <li><a href="rezervasyon.php">Rezervasyon Yap</a></li>     <!-- navbar tuşarı-->
                <li><a href="giris.php">Giriş</a></li>                      <!-- navbar tuşarı-->
                <li><a href="kayıtol.php">Kayıt Ol</a></li>                 <!-- navbar tuşarı-->
            </ul>
        </div>
    </div>
    <div class="container">
